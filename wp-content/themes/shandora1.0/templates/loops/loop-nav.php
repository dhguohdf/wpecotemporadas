<?php do_atomic('before_pagination'); ?>
	...
	<?php elseif ( is_singular() ) : ?>
		...
		<div class="loop-nav">
			<?php previous_post_link( '%link', '<span class="previous">' . __( '<span class="meta-nav">&larr;</span> Anterior', 'bon' ) . '</span>' ); ?>
			<?php next_post_link( '%link', '<span class="next">' . __( 'Próximo <span class="meta-nav">&rarr;</span>', 'bon' ) . '</span>' ); ?>
		</div><!-- .loop-nav -->
