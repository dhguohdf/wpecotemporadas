<article id="post-<?php the_ID(); ?>" class="<?php bon_entry_class(); ?>">
	...
	<?php if ( is_singular( get_post_type() ) ) { ?>
		...
		<header class="entry-header">
			...
			<?php echo apply_atomic_shortcode( 'entry_byline', '<div class="entry-byline">' . __( '[entry-icon class="show-for-large"] [entry-author] [entry-published format="M, d Y" text="Posted"] [entry-terms taxonomy="category"] [entry-edit-link]', 'bon' ) . '</div>' ); ?>
		</header><!-- .entry-header -->
	...
	<?php } else { ?>
		...
		<header class="entry-header">
			...
			<?php echo apply_atomic_shortcode( 'entry_byline', '<div class="entry-byline">' . __( '[entry-icon class="show-for-large"] [entry-author] [entry-published format="M, d Y" text="Posted"] [entry-edit-link]', 'bon' ) . '</div>' ); ?>
		</header><!-- .entry-header -->
