...
class Shandora_dsIDXpress_Search extends WP_Widget {
	...
	function form($instance) {
		...
		?>
			<p>
				<label for="<?php echo $titleFieldId; ?>">Widget title</label>
				<input id="<?php echo $titleFieldId; ?>" name="<?php echo $titleFieldName; ?>" value="<?php echo $title; ?>" class="widefat" type="text" />
			</p>

			<p>
				<h3>Fields to Display</h3>
				<div id="<?php echo $searchOptionsFieldId; ?>-show_checkboxes" class="search-widget-searchOptions">
					<input type="checkbox" id="<?php echo $searchOptionsFieldId; ?>-show_cities" name="<?php echo $searchOptionsFieldName; ?>[show_cities]" <?php echo $show_cities; ?> onclick="dsWidgetSearch.ShowBlock(this);"/>
					<label for="<?php echo $searchOptionsFieldId; ?>-show_cities">Cities</label><br />
					<input type="checkbox" id="<?php echo $searchOptionsFieldId; ?>-show_communities" name="<?php echo $searchOptionsFieldName; ?>[show_communities]" <?php echo $show_communities; ?> onclick="dsWidgetSearch.ShowBlock(this);"/>
					<label for="<?php echo $searchOptionsFieldId; ?>-show_communities">Communities</label><br />
					<input type="checkbox" id="<?php echo $searchOptionsFieldId; ?>-show_tracts" name="<?php echo $searchOptionsFieldName; ?>[show_tracts]" <?php echo $show_tracts; ?> onclick="dsWidgetSearch.ShowBlock(this);"/>
					<label for="<?php echo $searchOptionsFieldId; ?>-show_tracts">Tracts</label><br />
					<input type="checkbox" id="<?php echo $searchOptionsFieldId; ?>-show_zips" name="<?php echo $searchOptionsFieldName; ?>[show_zips]" <?php echo $show_zips; ?> onclick="dsWidgetSearch.ShowBlock(this);"/>
					<label for="<?php echo $searchOptionsFieldId; ?>-show_zips">Zips</label><br />
					<input type="checkbox" id="<?php echo $searchOptionsFieldId; ?>-show_mlsnumber" name="<?php echo $searchOptionsFieldName; ?>[show_mlsnumber]" <?php echo $show_mlsnumber; ?> onclick="dsWidgetSearch.ShowBlock(this);"/>
					<label for="<?php echo $searchOptionsFieldId; ?>-show_mlsnumber">MLS #'s</label><br />
<?php
		if($options["HasSearchAgentPro"] == "yes") {
			?>
					<input id="<?php echo $searchOptionsFieldId; ?>-show-advanced" name="<?php echo $searchOptionsFieldName; ?>[show_advanced]" class="checkbox" type="checkbox" <?php echo $show_advanced; ?> onclick="dsWidgetSearch.ShowBlock(this);"/>
					<label for="<?php echo $searchOptionsFieldId; ?>-show-advanced">Show Advanced Option</label>
<?php
		} ?>
				</div>
			</p>
