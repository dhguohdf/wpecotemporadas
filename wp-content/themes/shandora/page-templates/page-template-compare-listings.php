        ...
        do_atomic('before_loop'); ?>
                ...
                <?php if ( $wp_query->have_posts() ) : 
                    ...
                    <table id="comparison-table">
                      ...
                      <tbody>
                        <tr>
                          <th><?php _e('MLS #','bon'); ?></th>
                          <?php echo $output_mls; ?>
                        </tr>
                        <tr>
                          <th><?php _e('Address','bon'); ?></th>
                          <?php echo $output_address; ?>
                        </tr>
                        <tr>
                          <th><?php _e('Zip Postal','bon'); ?></th>
                          <?php echo $output_zip; ?>
                        </tr>
                        <tr>
                          <th><?php _e('Price','bon'); ?></th>
                          <?php echo $output_price; ?>
                        </tr>
                        <tr>
                          <th><?php _e('Mortgage Availability','bon'); ?></th>
                          <?php echo $output_mortgage; ?>
                        </tr>
                        <tr>
                          <th><?php _e('Furnishing','bon'); ?></th>
                          <?php echo $output_furnish; ?>
                        </tr>
                        <tr>
                          <th><?php _e('Property Type','bon'); ?></th>
                          <?php echo $output_type; ?>
                        </tr>
                        <tr>
                          <th><?php _e('Status','bon'); ?></th>
                          <?php echo $output_status; ?>
                        </tr>
                        <tr>
                          <th><?php _e('Bedrooms','bon'); ?></th>
                          <?php echo $output_bed; ?>
                        </tr>
                        <tr>
                          <th><?php _e('Bathrooms','bon'); ?></th>
                          <?php echo $output_bath; ?>
                        </tr>
                        <tr>
                          <th><?php _e('Garage','bon'); ?></th>
                          <?php echo $output_garage; ?>
                        </tr>
                        <tr>
                          <th><?php _e('Basement','bon'); ?></th>
                          <?php echo $output_basement; ?>
                        </tr>
                        <tr>
                          <th><?php _e('Floors','bon'); ?></th>
                          <?php echo $output_floor; ?>
                        </tr>
                        <tr>
                          <th><?php _e('Total Rooms','bon'); ?></th>
                          <?php echo $output_totalroom; ?>
                        </tr>
                        <tr>
                          <th><?php _e('Lot Size','bon'); ?></th>
                          <?php echo $output_lotsize; ?>
                        </tr>
                        <tr>
                          <th><?php _e('Building Size','bon'); ?></th>
                          <?php echo $output_buildingsize; ?>
                        </tr>
                        <tr>
                          <th><?php _e('Date Available','bon'); ?></th>
                          <?php echo $output_date; ?>
                        </tr>
                        <tr>
                          <th><?php _e('Year Built','bon'); ?></th>
                          <?php echo $output_year; ?>
                        </tr>
                        <tr>
                          <th><?php _e('Agent','bon'); ?></th>
