...
add_filter( 'bon_attr_body',    'bon_attr_body',    5    );
add_filter( 'bon_attr_header',  'bon_attr_header',  5    );
add_filter( 'bon_attr_footer',  'bon_attr_footer',  5    );
add_filter( 'bon_attr_content', 'bon_attr_content', 5    );
add_filter( 'bon_attr_sidebar', 'bon_attr_sidebar', 5, 2 );
add_filter( 'bon_attr_menu',    'bon_attr_menu',    5, 2 );

/* Header attributes. */
add_filter( 'bon_attr_site-title',       'bon_attr_site_title',       5 );
add_filter( 'bon_attr_site-description', 'bon_attr_site_description', 5 );

/* Loop attributes. */
add_filter( 'bon_attr_loop-meta',        'bon_attr_loop_meta',        5 );
add_filter( 'bon_attr_loop-title',       'bon_attr_loop_title',       5 );
add_filter( 'bon_attr_loop-description', 'bon_attr_loop_description', 5 );

/* Post-specific attributes. */
add_filter( 'bon_attr_post',            'bon_attr_post',            5    );
add_filter( 'bon_attr_entry',           'bon_attr_post',            5    ); // Alternate for "post".
add_filter( 'bon_attr_entry-title',     'bon_attr_entry_title',     5    );
add_filter( 'bon_attr_entry-author',    'bon_attr_entry_author',    5    );
add_filter( 'bon_attr_entry-published', 'bon_attr_entry_published', 5    );
add_filter( 'bon_attr_entry-content',   'bon_attr_entry_content',   5    );
add_filter( 'bon_attr_entry-summary',   'bon_attr_entry_summary',   5    );
add_filter( 'bon_attr_entry-terms',     'bon_attr_entry_terms',     5, 2 );

/* Comment specific attributes. */
add_filter( 'bon_attr_comment',           'bon_attr_comment',           5 );
add_filter( 'bon_attr_comment-author',    'bon_attr_comment_author',    5 );
add_filter( 'bon_attr_comment-published', 'bon_attr_comment_published', 5 );
add_filter( 'bon_attr_comment-permalink', 'bon_attr_comment_permalink', 5 );
add_filter( 'bon_attr_comment-content',   'bon_attr_comment_content',   5 );
 ...
 * @return string
 */
function bon_get_attr( $slug, $context = '', $attributes = array() ) {

	$out    = '';
	$attr   = apply_filters( "bon_attr_{$slug}", $attributes, $context );
 ...
 * @return array
 */
function bon_attr_content( $attr ) {
 ...
 * @return array
 */
function bon_attr_sidebar( $attr, $context ) {
 ...
 * @return array
 */
function bon_attr_menu( $attr, $context ) {
 ...
 * @return array
 */
function bon_attr_site_title( $attr ) {
 ...
 * @return array
 */
function bon_attr_site_description( $attr ) {
 ...
 * @return array
 */
function bon_attr_loop_meta( $attr ) {
 ...
 * @return array
 */
function bon_attr_loop_title( $attr ) {
 ...
 * @return array
 */
function bon_attr_loop_description( $attr ) {
...
function bon_attr_post( $attr ) {
	...
	if ( !empty( $post ) ) {
		...
		elseif ( 'attachment' === get_post_type() && bon_attachment_is_audio() ) {

			$attr['itemtype'] = 'http://schema.org/AudioObject';
		}

		elseif ( 'attachment' === get_post_type() && bon_attachment_is_video() ) {
 ...
 * @return array
 */
function bon_attr_entry_title( $attr ) {
 ...
 * @return array
 */
function bon_attr_entry_author( $attr ) {
 ...
 * @return array
 */
function bon_attr_entry_content( $attr ) {
 ...
 * @return array
 */
function bon_attr_entry_summary( $attr ) {
 ...
 * @return array
 */
function bon_attr_entry_terms( $attr, $context ) {
 ...
 * @return array
 */
function bon_attr_comment( $attr ) {
 ...
 * @return array
 */
function bon_attr_comment_author( $attr ) {
 ...
 * @return array
 */
function bon_attr_comment_permalink( $attr ) {
 ...
 * @return array
 */
function bon_attr_comment_content( $attr ) {
