...
add_filter( 'image_size_names_choose', 'bon_image_size_names_choose' );
 ...
 * @return array $sizes
 */
function bon_image_size_names_choose( $sizes ) {
...
function bon_attachment() {
	...
	foreach ( $mime_type as $type ) {
		if ( function_exists( "bon_{$type}_attachment" ) )
			$attachment = call_user_func( "bon_{$type}_attachment", $mime, $file );
 ...
 * @return string
 */
function bon_application_attachment( $mime = '', $file = '' ) {
 ...
 * @return string
 */
function bon_text_attachment( $mime = '', $file = '' ) {
	$embed_defaults = wp_embed_defaults();
 ...
 * @return string
 */
function bon_audio_attachment( $mime = '', $file = '' ) {
	$embed_defaults = wp_embed_defaults();
 ...
 * @return string
 */
function bon_video_attachment( $mime = false, $file = false ) {
	$embed_defaults = wp_embed_defaults();
