...
add_action( 'init', 'theme_layouts_add_post_type_support', 30 );
add_action( 'init', 'theme_layouts_remove_post_type_support', 35 );
...
function theme_layouts_remove_post_type_support() {
	...
	if ( function_exists( 'bon_toolkit_setup_poll_post_type' ) )
		remove_post_type_support( 'poll', 'theme-layouts' );
	if ( function_exists( 'bon_toolkit_setup_quiz_post_type' ) )
		remove_post_type_support( 'quiz', 'theme-layouts' );
}
 ...
 * @return array $strings
 */
function theme_layouts_image_strings() {

	/* Set up the default layout strings. */
	$strings = array(
		'default' => trailingslashit( BON_IMAGES ) . 'default.png',
		'1c'      => trailingslashit( BON_IMAGES ) . '1c.png',
		'2c-l'    => trailingslashit( BON_IMAGES ) . '2c-l.png',
		'2c-r'    => trailingslashit( BON_IMAGES ) . '2c-r.png',
 ...
 * @return string
 */
function theme_layouts_get_image_string( $layout ) {

	/* Get an array of post layout strings. */
	$strings = theme_layouts_image_strings();
