 ...
 * @since 1.0
 */
class Shandora_Featured_Car_Listing_Widget extends WP_Widget {
	...
	function __construct() {
		...
		$widget_options = array(
			'classname'   => 'featured-car-listing',
		...
		/* Create the widget. */
		$this->WP_Widget(
			'shandora-featured-car-listing',               // $this->id_base
			__( 'Shandora Featured Car Listing', 'bon' ), // $this->name
