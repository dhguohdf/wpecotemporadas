...
add_filter( 'date_template', 'bon_date_template' );

/* Filter the author/user template. */
add_filter( 'author_template', 'bon_user_template' );

/* Filter the tag and category (taxonomy) templates. */
add_filter( 'tag_template', 'bon_taxonomy_template' );
add_filter( 'category_template', 'bon_taxonomy_template' );
add_filter( 'taxonomy_template', 'bon_taxonomy_template' );

/* Filter the single, page, and attachment (singular) templates. */
add_filter( 'single_template', 'bon_singular_template' );
add_filter( 'page_template', 'bon_singular_template' );
add_filter( 'attachment_template', 'bon_singular_template' );

/* Filter the comments template. */
add_filter( 'comments_template', 'bon_comments_template' );
 ...
 */
function bon_date_template( $template ) {
	$templates = array();
 ...
 */
function bon_user_template( $template ) {
	$templates = array();
 ...
 * @return string Full path to file.
 */
function bon_taxonomy_template( $template ) {
 ...
 */
function bon_singular_template( $template ) {
 ...
 */
function bon_comments_template( $template ) {
