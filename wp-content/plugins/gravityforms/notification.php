...
Class GFNotification {
    ...
    public static function notification_list_page($form_id) {
        ...
        <h3><span><i class="icon-envelope-alt"></i> <?php _e("Notifications", "gravityforms") ?><a id="add-new-confirmation" class="add-new-h2" href="<?php echo $add_new_url?>"><?php _e("Add New", "gravityforms") ?></a></span></h3>
