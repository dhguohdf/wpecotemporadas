...
class GFForms {
    ...
    public static $version = '1.8.beta1';
...
//--------------- ALL OTHER PAGES ----------------------
    ...
    public static function resend_notifications(){
        ...
        if(0 == $leads){
            ...
            $search_criteria[] = array("key" => "status", "type" => "info", "value" => $status );

            if($star)
                $search_criteria[] = array("key" => "is_starred", "type" => "info", "value" => (bool) $star );
            if($read)
                $search_criteria[] = array("key" => "is_read", "type" => "info", "value" => (bool) $read );
            ...
            if(isset($_POST["fieldId"]) && $_POST["fieldId"] !== ''){
                ...
                $search_criteria[] = array(
                    "key" => $key,
                    "type" => rgempty("type", $_POST) ? "field" : rgpost("type"),
...
//----------- AJAX CALLS --------------------------
	...
	public static function get_toolbar_menu_items($form_id, $compact = false){
		...
		$menu_items['edit'] = array(
			...
			'icon' 			=> '<i class="icon-edit icon-large"></i>',
		...
		$menu_items['settings'] = array(
			...
			'icon' 			=> '<i class="icon-cogs icon-large"></i>',
		...
		$menu_items['entries'] = array(
			...
			'icon' 			=> '<i class="icon-comment-alt icon-large"></i>',
		...
		$menu_items['preview'] = array(
			...
			'icon' 			=> '<i class="icon-eye-open icon-large"></i>',
