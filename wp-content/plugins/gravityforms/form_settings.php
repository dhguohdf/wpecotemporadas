...
class GFFormSettings {
    ...
    public static function form_settings_ui() {
        ...
        */
        ...
        <h3><span><i class="icon-cogs"></i> <?php _e("Form Settings", "gravityforms") ?></span></h3>
    ...
    public static function confirmations_list_page($form_id) {
        ...
        <h3><span><i class="icon-envelope-alt"></i> <?php _e("Confirmations", "gravityforms") ?><a id="add-new-confirmation" class="add-new-h2" href="<?php echo $add_new_url ?>"><?php _e("Add New", "gravityforms") ?></a></span></h3>
