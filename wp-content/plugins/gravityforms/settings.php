...
class GFSettings{
    ...
    <form action="" method="post">
            ...
            <h3><span><i class="icon-ban-circle"></i> <?php _e("Uninstall Gravity Forms", "gravityforms"); ?></span></h3>
                <div class="delete-alert alert_red">

                    <h3><i class="icon-warning-sign gf_invalid"></i> <?php _e("Warning", "gravityforms"); ?></h3>
                    <p><strong><?php _e("This operation deletes ALL Gravity Forms data.", "gravityforms"); ?></strong> <?php _e("If you continue, You will not be able to retrieve or restore your forms or entries.", "gravityforms"); ?></p>
    ...
    public static function gravityforms_settings_page(){
        ...
        <form method="post">
            ...
            <h3><span><i class="icon-cogs"></i> <?php _e("General Settings", "gravityforms"); ?></span></h3>
                   ...
                   <th scope="row"><label for="gforms_key"><?php _e("Support License Key", "gravityforms"); ?></label>  <?php gform_tooltip("settings_license_key") ?></th>
                    <td>
                        ...
                        if(!rgempty("is_error", $version_info))
                            ...
                            $key_field .= "&nbsp;<i class='icon-ok gf_keystatus_valid'></i> <span class='gf_keystatus_valid_text'>" . __("Valid Key : Your license key has been successfully validated.", "gravityforms") . "</span>";
                        else if (!empty($key))
                            $key_field .= "&nbsp;<i class='icon-remove gf_keystatus_invalid'></i> <span class='gf_keystatus_invalid_text'>" . __("Invalid or Expired Key : Please make sure you have entered the correct value and that your key is not expired.", "gravityforms") . "</span>";
            ...
            <div class="hr-divider"></div>
              ...
              <h3><span><i class="icon-cogs"></i> <?php _e("reCAPTCHA Settings", "gravityforms"); ?></span></h3>
           ...
           <?php } ?>
              ...
              <h3><span><i class="icon-dashboard"></i> <?php _e("Installation Status", "gravityforms"); ?><span></h3>
              <table class="form-table">
                    ...
                    <td>
                        <?php
                            if(version_compare(phpversion(), '5.0.0', '>')){
                                ?>
                                <i class="icon-ok gf_valid"></i>
                                <?php
                            }
                            else{
                                ?>
                                <i class="icon-remove gf_invalid"></i>
