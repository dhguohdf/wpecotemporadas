...
class GFEntryDetail{
        ...
        <form method="post" id="entry_form" enctype='multipart/form-data'>
            ...
            <div class="gf_entry_detail_pagination">
                <ul>
                    ...
                    <li class="gf_entry_prev gf_entry_pagination"><?php echo GFEntryDetail::entry_detail_pagination_link($prev_pos, 'Previous Entry', 'gf_entry_prev_link', "icon-circle-arrow-left"); ?></li>
                    <li class="gf_entry_next gf_entry_pagination"><?php echo GFEntryDetail::entry_detail_pagination_link($next_pos, 'Next Entry', 'gf_entry_next_link', "icon-circle-arrow-right"); ?></li>
                </ul>
            </div>
            <?php } ?>
    ...
    public static function entry_detail_pagination_link($pos, $label = '', $class = '', $icon = '') {
        ...
        //$icon .= !rgblank($pos) ? '<i class="icon-circle-arrow-right icon-large"></i>' : '<i class="icon-circle-arrow-left icon-large"></i>';

        return '<a ' . $href . ' class="' . $class . '" title="' . $label . '"><i class="icon-large ' . $icon . '"></i></a></li>';
    }
