...
class Reserva_WP_Options {
	...
	function scripts() {
		...
		if ( isset( $_GET['page'] ) && $this->id == $_GET['page'] ) {
			...
			// Theme Options.
			wp_enqueue_style( 'odin-admin', RESERVAWPURL . 'css/odin-admin.css', array(), null, 'all' );
			wp_enqueue_script( 'odin-admin', RESERVAWPURL . 'js/odin-admin.js', array( 'jquery' ), null, true );
