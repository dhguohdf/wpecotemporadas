...
add_action( 'widgets_init', 'load_bon_toolkit_search_widget' );

function load_bon_toolkit_search_widget() {
	register_widget( 'Bon_Toolkit_Widget_Search' );
}

class Bon_Toolkit_Widget_Search extends WP_Widget {
	...
	function __construct() {
		...
		$widget_options = array(
			'classname'   => 'search',
			'description' => esc_html__( 'An advanced widget that gives you total control over the output of your search form.', 'bon-toolkit' )
		);
		...
		/* Create the widget. */
		$this->WP_Widget(
			'bon-toolkit-search',               // $this->id_base
			BON_TOOLKIT_PREFIX . ' ' . __( 'Search', 'bon-toolkit' ), // $this->name
	...
	function form( $instance ) {
		...
		$defaults = array(
			'title'         => esc_attr__( 'Search', 'bon-toolkit' ),
			'theme_search'  => false,
			'search_label'  => '',
			'search_text'   => '',
			'search_submit' => ''
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'search_label' ); ?>"><?php _e( 'Search Label:', 'bon-toolkit' ); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'search_text' ); ?>"><?php _e( 'Search Text:', 'bon-toolkit' ); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'search_submit' ); ?>"><?php _e( 'Search Submit:', 'bon-toolkit' ); ?></label>
		...
		<p>
			...
			<input class="checkbox" type="checkbox" <?php checked( $instance['theme_search'], true ); ?> id="<?php echo $this->get_field_id( 'theme_search' ); ?>" name="<?php echo $this->get_field_name( 'theme_search' ); ?>" /> <?php _e( 'Use theme\'s <code>searchform.php</code>?', 'bon-toolkit' ); ?></label>
		</p>
		</div>
