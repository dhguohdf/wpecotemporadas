...
class BON_Toolkit_Builder_Interface {
    ...
    public function render_service($value) {
        ...
        $icon            = '<a href="'. $value['button_link'] .'"><div class="' . $value['icon_style'] . '-icon icon-wrapper"><i class="' . $value['icon_class'] . ' icon-anim-' . $value['icon_animation'] . '"></i></div>';
        $title           = '<h2>' . $value['title'] . '</h2></a>';
