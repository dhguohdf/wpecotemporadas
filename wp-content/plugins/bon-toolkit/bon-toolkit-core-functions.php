...
if( !function_exists('bon_toolkit_get_contact_form') ) {
	function bon_toolkit_get_contact_form($email = '') {
        ...
        $o .= '<label for="name">'.__('Nome Completo', 'bon-toolkit').'</label>';
        $o .= '<input type="text" value="" name="name" class="name required" placeholder="'.__('Nome', 'bon').'" />';
        $o .= '<div class="contact-form-error">'.__('Por favor, digite seu nome completo.','bon-toolkit').'</div>';
        $o .= '</div>';

        $o .= '<div class="contact-form-input">';
        $o .= '<label for="email-address">'.__('Email', 'bon-toolkit').'</label>';
        $o .= '<input type="email" value="" name="email" class="email-address required" placeholder="'.__('Email', 'bon').'" />';
        $o .= '<div class="contact-form-error">'.__('Por favor, digite um endereço de email válido, para que possamos contatá-lo..','bon-toolkit').'</div>';
        $o .= '</div>';

        $o .= '<div class="contact-form-input">';
        $o .= '<label for="subject">'.__('Assunto', 'bon-toolkit').'</label>';
        $o .= '<input type="text" value="" name="subject" class="subject" placeholder="'.__('Assunto', 'bon').'" />';
        $o .= '</div>';

        $o .= '<div class="contact-form-input">';
        $o .= '<label for="messages">'.__('Sua mensagem', 'bon-toolkit').'</label>';
        $o .= '<textarea name="messages" class="messages required" placeholder="'.__('Mensagem', 'bon').'"></textarea>';
        $o .= '<div class="contact-form-error">'.__('Digite aqui sua mensagem.','bon-toolkit').'</div>';
        $o .= '</div>';

        $o .= '<input type="hidden" name="receiver" value="'.$email.'" />';

        $o .= '<div class="contact-form-input">';
        $o .= '<button type="submit" class="contact-form-submit bon-toolkit-button round-corner blue flat" name="submit">'.__('Enviar mensagem','bon-toolkit').'</button>';
