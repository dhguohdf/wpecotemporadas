 ...
 * @version   $Id: CcSelectField.php 937488 2014-06-23 21:21:03Z worschtebrot $
 * @package   
 */ 
class Psn_Test_CcSelectField implements IfwPsn_Wp_Plugin_Selftest_Interface
{
    ...
    {
        return __('Cc multi selection field', 'psn');
    }
    ...
    {
        if ($this->_dbPatcher->isFieldCcSelect()) {
            $this->_result = true;
        }
    }
    ...
    {
        $this->_dbPatcher->createRulesFieldCcSelect();
