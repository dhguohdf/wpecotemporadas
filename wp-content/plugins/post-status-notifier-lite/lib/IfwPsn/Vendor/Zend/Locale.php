 ...
 *
 * @category  Zend
 * @package   IfwPsn_Vendor_Zend_Locale
 * @copyright  Copyright (c) 2005-2014 Zend Technologies USA Inc. (http://www.zend.com)
 * @license   http://framework.zend.com/license/new-bsd     New BSD License
 * @version   $Id: Locale.php 911603 2014-05-10 10:58:23Z worschtebrot $
 */
 ...
 * @license   http://framework.zend.com/license/new-bsd     New BSD License
 */
class IfwPsn_Vendor_Zend_Locale
{
    /**
     ...
     *
     * @param  string|IfwPsn_Vendor_Zend_Locale $locale (Optional) Locale for parsing input
     * @throws IfwPsn_Vendor_Zend_Locale_Exception When autodetection has been failed
     */
    ...
    public static function getDefault()
    {
        if ((self::$compatibilityMode === true) or (func_num_args() > 0)) {
            if (!self::$_breakChain) {
                ...
                trigger_error('You are running IfwPsn_Vendor_Zend_Locale in compatibility mode... please migrate your scripts', E_USER_NOTICE);
     ...
     *
     * @param  string|IfwPsn_Vendor_Zend_Locale $locale  Locale to set
     * @param  float              $quality The quality to set from 0 to 1
     * @throws IfwPsn_Vendor_Zend_Locale_Exception When a autolocale was given
     * @throws IfwPsn_Vendor_Zend_Locale_Exception When a unknown locale was given
     * @return void
     */
    public static function setDefault($locale, $quality = 1)
    {
        if (($locale === 'auto') or ($locale === 'root') or ($locale === 'default') or
            ...
            throw new IfwPsn_Vendor_Zend_Locale_Exception('Only full qualified locales can be used as default!');
        }

        if (($quality < 0.1) or ($quality > 100)) {
            require_once IFW_PSN_LIB_ROOT . 'IfwPsn/Vendor/Zend/Locale/Exception.php';
            throw new IfwPsn_Vendor_Zend_Locale_Exception("Quality must be between 0.1 and 100");
        }
        ...
        if (isset(self::$_localeData[(string) $locale]) === true) {
            ...
            if (isset(self::$_localeData[$elocale[0]]) === true) {
                ...
                require_once IFW_PSN_LIB_ROOT . 'IfwPsn/Vendor/Zend/Locale/Exception.php';
                throw new IfwPsn_Vendor_Zend_Locale_Exception("Unknown locale '" . (string) $locale . "' can not be set as default!");
            }
        }
    ...
    public static function getEnvironment()
    {
        ...
        require_once IFW_PSN_LIB_ROOT . 'IfwPsn/Vendor/Zend/Locale/Data/Translation.php';
        ...
        foreach ($languages as $locale) {
            ...
            if ($language !== 'C') {
                ...
                $language = str_ireplace(
                    array_keys(IfwPsn_Vendor_Zend_Locale_Data_Translation::$languageTranslation),
                    array_values(IfwPsn_Vendor_Zend_Locale_Data_Translation::$languageTranslation),
                    (string) $language
                );

                $language = str_ireplace(
                    array_keys(IfwPsn_Vendor_Zend_Locale_Data_Translation::$regionTranslation),
                    array_values(IfwPsn_Vendor_Zend_Locale_Data_Translation::$regionTranslation),
                    $language
                );
     ...
     * Sets a new locale
     *
     * @param  string|IfwPsn_Vendor_Zend_Locale $locale (Optional) New locale to set
     * @return void
     */
     ...
     *
     * @param  IfwPsn_Vendor_Zend_Locale $object Locale to check for equality
     * @return boolean
     */
    public function equals(IfwPsn_Vendor_Zend_Locale $object)
    {
     ...
     * @param  string|IfwPsn_Vendor_Zend_Locale $locale (Optional) Locale|Language for which this informations should be returned
    ...
    public static function getTranslationList($path = null, $locale = null, $value = null)
    {
        ...
        $result = IfwPsn_Vendor_Zend_Locale_Data::getList($locale, $path, $value);
     ...
     *
     * @param  string|IfwPsn_Vendor_Zend_Locale $locale (Optional) Locale for language translation
     * @return array
     * @deprecated
     */
     ...
     *
     * @param  string|IfwPsn_Vendor_Zend_Locale $locale (Optional) Locale for script translation
     * @return array
     * @deprecated
     */
     ...
     *
     * @param  string|IfwPsn_Vendor_Zend_Locale $locale (Optional) Locale for country translation
     * @return array
     * @deprecated
     */
     ...
     *
     * @param  string|IfwPsn_Vendor_Zend_Locale $locale (Optional) Locale for territory translation
     * @return array
     * @deprecated
     */
    ...
    public static function getTranslation($value = null, $path = null, $locale = null)
    {
        require_once IFW_PSN_LIB_ROOT . 'IfwPsn/Vendor/Zend/Locale/Data.php';
        $locale = self::findLocale($locale);
        $result = IfwPsn_Vendor_Zend_Locale_Data::getContent($locale, $path, $value);
     ...
     *
     * @param  string|IfwPsn_Vendor_Zend_Locale $locale     Locale to check for
    ...
    {
        if (($locale instanceof IfwPsn_Vendor_Zend_Locale)
    ...
    {
        require_once IFW_PSN_LIB_ROOT . 'IfwPsn/Vendor/Zend/Locale/Data.php';
        return IfwPsn_Vendor_Zend_Locale_Data::hasCache();
    }
    ...
    {
        require_once IFW_PSN_LIB_ROOT . 'IfwPsn/Vendor/Zend/Locale/Data.php';
        IfwPsn_Vendor_Zend_Locale_Data::clearCache($tag);
    }
     ...
     *
     * @param  string|IfwPsn_Vendor_Zend_Locale $locale (Optional) Locale to work on
     * @param  boolean            $strict (Optional) Strict preparation
     * @throws IfwPsn_Vendor_Zend_Locale_Exception When no locale is set which is only possible when the class was wrong extended
     * @return string
     */
    private static function _prepareLocale($locale, $strict = false)
    {
        ...
        // This can only happen when someone extends IfwPsn_Vendor_Zend_Locale and erases the default
        if ($locale === null) {
            require_once IFW_PSN_LIB_ROOT . 'IfwPsn/Vendor/Zend/Locale/Exception.php';
            throw new IfwPsn_Vendor_Zend_Locale_Exception('Autodetection of Locale has been failed!');
        }
