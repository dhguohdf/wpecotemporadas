 ...
 * @version  $Id: Email.php 911603 2014-05-10 10:58:23Z worschtebrot $
 */ 
class IfwPsn_Wp_Email
{
    ...
    {
        return IfwPsn_Wp_Proxy::mail($this->getTo(), $this->getSubject(), $this->getMessage(), $this->_getAdjustedHeaders(),
            $this->getAttachments());
    }
}
