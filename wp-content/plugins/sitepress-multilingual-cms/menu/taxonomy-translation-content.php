...
<div id="wpml_tt_taxonomy_translation_wrap">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <table class="icl_tt_popup">
                            <tr><th colspan="2"><?php printf(__('Translate %s in %s', 'sitepress'), '<strong>' . $term->name . '</strong>', $this->selected_languages[$language['code']]['display_name']); ?></th></tr>
                            <tr>
    ...
    <p>
        ...
        <?php printf(__('The strings on the first column are the are in %s (the strings language)', 'sitepress'), $strings_lang['display_name']); ?>
    </p>
    <?php endif; ?>
            ...
            <tbody>
                <tr>
                    ...
                    <td>
                        ...
                        <a class="icl_tt_labels_<?php echo $this->taxonomy . '_' . $language?><?php echo $class ?>" href="#" onclick="WPML_Translate_taxonomy.show_labels_form('<?php echo $this->taxonomy ?>','<?php echo $language ?>'); return false;">
