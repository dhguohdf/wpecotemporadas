                            ...
                            <td>
                                ...
                                <ul>
                                    ...
                                    <li>
                                        ...
                                        <p id="icl_use_directory_wrap" style="margin:5px 0 0 20px; <?php if($sitepress_settings['language_negotiation_type'] != 1): ?>display:none;<?php endif; ?>" >
                                        <label>
                                            <input type="checkbox" name="use_directory" id="icl_use_directory" value="1" <?php if(!empty($sitepress_settings['urls']['directory_for_default_language'])): 
                                                ?>checked="checked"<?php endif; ?> />
                                            <?php _e('Use directory for default language', 'sitepress') ?>
                                        </label>
                                        
                                        <span id="icl_use_directory_details" <?php if(empty($sitepress_settings['urls']['directory_for_default_language'])) echo ' style="display:none"'  ?> >
                                        <br /><br />
                                        <?php _e('What to show for the root url:', 'sitepress') ?>
                                            <br />
                                            <span class="icl_error_text icl_error_1" style="display: none;"><?php _e('Please select what to show for the root url.', 'sitepress') ?><br /></span>
                                            <label>
                                                ...
                                                ?>checked="checked"<?php endif; ?> />
                                                <?php _e('HTML file - please enter path: absolute or relative to the WordPress installation folder', 'sitepress') ?>
                                            </label>    
                                                <input type="text" name="root_html_file_path" value="<?php echo $sitepress_settings['urls']['root_html_file_path']?>" />                                            
                                            <br />
                                            <label>
                                                <input id="wpml_show_on_root_page" type="radio" name="show_on_root" value="page" <?php if($sitepress_settings['urls']['show_on_root'] == 'page'): 
                                                ?>checked="checked"<?php endif; ?>  <?php if($sitepress_settings['urls']['show_on_root'] == 'page'):?>class="active"<?php endif; ?> />
                                                <?php _e('A page', 'sitepress') ?>    
                                                
                                                <span style="display: none;" id="wpml_show_page_on_root_x"><?php echo esc_js(__("Please save the settings first by clicking Apply.", 'sitepress')); ?></span>
                                            ...
                                            <span id="icl_hide_language_switchers" <?php if($sitepress_settings['urls']['show_on_root'] != 'page'): 
                                                ?>style="display:none"<?php endif; ?>>                                            
                                            <br />
                                            <label style="margin:8px 0 0 20px; display: block;">
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            ...
                                            <ul>
                                                <li>
                                                    <label>
                                                        <input class="icl_ls_include" type="checkbox" name="icl_lso_flags" value="1" <?php if($sitepress_settings['icl_lso_flags']):?>checked="checked"<?php endif?> />
                                                        <?php echo __('Flag', 'sitepress') ?>
                                                    </label>
                                                </li>
                                                <li>
                                                <label>
                                                    <input class="icl_ls_include" type="checkbox" name="icl_lso_native_lang" value="1" <?php if($sitepress_settings['icl_lso_native_lang']):?>checked="checked"<?php endif?> />
                                                    <?php echo __('Native language name (the language name as it\'s written in that language)', 'sitepress') ?>
                                                </label>                    
                                                </li>
                                                <li>
                                                <label>
                                                    <input class="icl_ls_include" type="checkbox" name="icl_lso_display_lang" value="1" <?php if($sitepress_settings['icl_lso_display_lang']):?>checked="checked"<?php endif?> />
                                        ...
                                        <li>
                                            <h4><?php echo __('Preserve url parameters', 'sitepress')?></h4>
                                            <?php echo __('These url parameters will be copied to the translated urls in the language switcher. Enter parameters separated by commas.', 'sitepress') ?><br />
                    ...
                    <tbody>
                        <tr>
                            <td>
                                ...
                                <p><em><?php _e("This feature uses Javascript. Make sure that your site doesn't have JS errors.", 'sitepress'); ?></em></p>                                
