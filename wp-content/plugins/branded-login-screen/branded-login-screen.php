...
define( 'BLS_BG_IMG',       'background_admin.jpg' ); 
...
class Branded_Login_Screen
{
	...
	public function branded_login_screen_styles() {
		...
		<link rel="stylesheet" id="custom_wp_admin_css"  href="<?php echo plugins_url( '/assets/c/branded-login-screen.css', __FILE__ ); ?>" type="text/css" media="all" />
		<?php
	}
